      ...
      <main className="p-8 max-w-6xl mx-auto space-y-24">
        ...
        <section className="flex flex-col md:flex-row items-center md:space-x-12">
          ...
          >
            ...
            <p className="text-lg leading-relaxed">
              <strong>Address:</strong> Department of Information Management and Finance, National Yang Ming Chiao Tung University, 1001 University Road, Hsinchu City 300093, Taiwan
              <br />
              <strong>Email:</strong> shih-yu.tsai@nycu.edu.tw
            </p>
            <p className="text-lg leading-relaxed">
        ...
        <section>
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-2xl font-semibold mb-6">🏆 Honors</h3>
            <ul className="list-disc list-inside space-y-2 text-lg leading-relaxed">
              <li>Resource Access Project Travel Grant, SBU</li>
              <li>Special CS Department Chair Fellowship, SBU</li>
              <li>Excellent Thesis Award, Symposium for Young Combinatorialists</li>
              <li>Academic Excellence Award, NCTU</li>
              <li>Hu-Dun-Fu Scholarship, NCTU</li>
            </ul>
          </motion.div>
        </section>
